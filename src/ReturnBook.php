...
?> 
<html>
<body style="background-color: #8C1C73">
<center><u><h1>Return Book</u></center></h1>

<form action="" method="post">
<table>
<tr>
    <td><mark>Enter your issue ID</mark></td>
...
<input type="submit" value="Return" style="background-color:pink"/>
</form>
