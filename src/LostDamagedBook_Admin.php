...
<html>
<body style="background-color:#FFCC7A">
<center><b><i><u><h1><mark>Lost Damaged Book</mark></b></i></u></h1>
...
<input type="submit" value="Look for the last user" style="background-color: #CCD699"/>
</form>
...
<input type="submit" value="Submit" style="background-color: #CCD699"/>
</form>

<form action="AdminSummary.php" method="post">
<input type="submit" value="Back" style="background-color: #CCD699"/>
</form>
